    ...
    <div class="wrap"><!-- Header Start -->
        ...
        <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12" id="contact-form">
                        ...
                        <p>
                            ...
                            n'hésitez pas à nous contacter dès maintenant pour obtenir un devis gratuit. Nous serons
                            heureux de discuter de vos besoins en matière de plomberie et de vous proposer les
                            meilleures solutions pour répondre à vos besoins. Faites confiance à notre expertise et à
                            notre expérience pour tous vos besoins en matière de plomberie à Casablanca.
                            ...
                            <form method="POST">
                                <div id="contactFormHolder">
                                    <div class="inputAndLabelCon">
                                        <label for=""> <strong>Nom/Prenom</strong><span
                                                class="necessary">*</span></label><br>
         ...
         height: 40px; " required="">
                                    ...
                                    <div class="inputAndLabelCon">
                                        <label for=""> <strong>Ville</strong><span
                                                class="necessary">*</span></label><br>
         ...
         height: 40px; " type="tel" name="senderTel" placeholder="Tél" maxlength="10"
                                    ...
                                    <div class="inputAndLabelCon">
                                        <label for=""> <strong>Email</strong><span
                                                class="necessary">*</span></label><br>
                                        <input style=" border: 1px solid #5AC8E8 !important; border-radius: 10px;
         font-family: arial;
         font-Weight: bold;
         ...
         height: 40px; " type="text" name="senderEmail" placeholder="Email" required="">
                                    ...
                                    <div class="inputAndLabelCon" id="rt">
                                        <label> <strong>Type de local</strong><span
                                                class="necessary">*</span></label><br>
         ...
         height: 40px; " required="">
                                    ...
                                    <div class="inputAndLabelCon" id="rt">
                                        <label> <strong>Type de services</strong><span
                                                class="necessary">*</span></label><br>
                                        <select name="ProOrPar" id="TypeLocal" style=" border: 1px solid #5AC8E8 !important;
         font-family: arial;
         font-Weight: bold;
         ...
         color: #6c757d;  width: 100%;
         height: 40px; " required="">
                                            <option value="" disabled="" selected="" hidden="">Choisissez le type
                                                service</option>
                                    ...
                                    <div class="inputAndLabelCon" id="rt">
                                        <label for=""> <strong>Sujet</strong><span
                                                class="necessary">*</span></label><br>
         ...
         height: 40px; " id="pr">
                                    ...
                                    <div class="inputAndLabelCon" id="rt">
                                        <label for=""> <strong> Autre </strong><span
                                                class="necessary">*</span></label><br>
                                        <input style=" border: 1px solid #5AC8E8 !important; border-radius: 10px;
         font-family: arial;
         font-Weight: bold;
         ...
         height: 40px; " type="text" name="messageSubject3" id="atr" placeholder="Autre">
                                    ...
                                    <div class="inputAndLabelCon" id="messageTxt">
                                        <label for=""><strong>Message</strong> <span
                                                class="necessary">*</span></label><br>
                    ...
                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                        ...
                        <div class="content-box-info" style="text-align: left;">
                            ...
                            <ul class="check-list why">
                                <li><a href="reparation-fuite-eau-casablanca.php">Reparation fuite d'eau à
                                        Casablanca</a></li>
                                <li><a href="remplacement-chauffe-eau-electrique-casablanca.php">Chauffe eau electrique
                                        à Casablanca</a></li>
                                ...
                                <li><a href="debouchage-machine-laver-casablanca.php">Debouchage machine à laver à
                                        casablanca</a></li>
                                <li><a href="depannage-plomberie-casablanca.php">Depannage plomberie à casablanca</a>
                                </li>
                                <li><a href="debouchage-canalisation-casablanca.php">Debouchage canalisation à
                                        casablanca</a></li>
                                <li><a href="remplacement-robinet-casablanca.php">Remplacement robinet à casablanca</a>
                                </li>
                                <li><a href="ballon-eau-chaude-casablanca.php">Ballon d'eau chaude à casablanca</a>
                                </li>
                                <li><a href="urgence-plombier-casablanca.php">Urgence plombier à casablanca</a></li>
                                <li><a href="installation-chaudiere-casablanca.php">Installation chaudiere à
                                        casablanca</a></li>
                                <li><a href="installation-plomberie-casablanca.php">Installation de plomberie à
                                        casablanca</a></li>
                        ...
                        <div class="button-devis">
                            <button class="btn btn-special btn-color pull-right"
                                ...
                                <span onmouseover="hover()" onmouseout="out()" class="icon-phone" id="icon-phone"
