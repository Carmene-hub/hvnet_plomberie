...
$remplacement_robinet= $conn->prepare("SELECT * from remplacement_robinet Limit 1");
$remplacement_robinet->execute();
$remplacement_robinet = $remplacement_robinet->fetch();
...
<head>
  ...
  <title> Societe de remplacement robinet casablanca - HVNET PLOMBERIE</title>
  <meta name="description"
    content="Societe de remplacement robinet societe professionel dans le remplacement robinet au maroc">
    <meta name="keywords" content="Remplacement robinet casablanca , societe de remplacement robinet  casablanca , robinet  casablanca , entreprise remplacement robinet casablanca, Remplacement robinet casablanca Maroc , societe remplacement robinet casablanca Maroc , Remplacement robinet Maroc, Remplacement robinet Maroc, societe remplacement robinet  Maroc , Remplacement robinet Maroc">
  ...
  <!-- Link canonique -->
  <link rel="canonical" href="index.php/remplacement-robinet-casablanca.php">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            ...
            <div class="elementor-text-editor elementor-clearfix">
              <h1 id="paragraphe" class="titre-principal" style="text-align: center;"><strong>Remplacement Robinet Casablanca</strong></h1>
             <?php echo $remplacement_robinet["presentation"];?>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <img id="imgser" alt="societe professionel dans le remplacement robinet a casablanca"
            src="./admin/pages/remplacement_robinet/imgs/<?php echo $remplacement_robinet["img1"]?>">
          </div>
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
                <h1 id="paragraphe" class="titre-secend"></h1><strong>Comment demonter un robinet</strong></h1>
                <p>Une fois l'arrivée d'eau coupée, vous pouvez démonter le robinet. Tout d'abord, retirez le capuchon décoratif du robinet. Ensuite, utilisez une clé à molette pour dévisser l'écrou qui maintient le robinet en place. Si l'écrou est trop serré, utilisez une clé à tube ou une clé à douille pour desserrer l'écrou. Une fois l'écrou retiré, retirez le robinet en le soulevant de la tige.
                </p>
                <p>Après avoir retiré le robinet, nettoyez la tige pour enlever tout dépôt ou résidu qui pourrait obstruer le nouveau robinet. Utilisez du papier de verre pour éliminer les résidus ou les dépôts et assurez-vous que la tige est propre avant de procéder à l'installation du nouveau robinet.</p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
                <h2 id="paragraphe" class="titre-principal" style="text-align: center;"><strong>Remplacement Robinet</strong></h1>
                  <p>Avant d'installer le nouveau robinet, vérifiez qu'il convient à votre évier ou à votre lavabo. Ensuite, insérez le nouveau robinet sur la tige et utilisez une clé à molette pour serrer l'écrou. Assurez-vous que le robinet est bien fixé en le faisant tourner de gauche à droite. Enfin, remplacez le capuchon décoratif sur le robinet.
                    <br>Si vous rencontrez des difficultés il est recommandé de faire appel à un plombier professionnel pour effectuer le remplacement du robinet.
                  </p>
                  <p>Une fois que le nouveau robinet est installé, il est temps de rallumer l'arrivée d'eau. Ouvrez la vanne d'arrêt et laissez l'eau couler pendant quelques minutes pour vérifier s'il y a des fuites. Si vous remarquez une fuite, serrez l'écrou à nouveau pour résoudre le problème
                  </p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <div class="elementor-text-editor elementor-clearfix">
                  <h2 id="paragraphe" class="titre-secend"><strong>Verification du fonctionnement d'un robinet</strong></h1>
                    <p>Le robinet est l'un des éléments les plus importants dans une installation de plomberie. Il est utilisé pour contrôler l'écoulement de l'eau dans une maison, que ce soit pour la cuisine, la salle de bain ou d'autres pièces. Un robinet défectueux peut causer des problèmes tels que des fuites d'eau, une pression d'eau insuffisante ou des interruptions de l'écoulement de l'eau. C'est pourquoi il est important de savoir comment vérifier le bon fonctionnement d'un robinet.
                      <br>Enfin, vérifiez que le nouveau robinet fonctionne correctement. Ouvrez et fermez le robinet plusieurs fois pour vous assurer que l'eau coule correctement et que le robinet est bien fixé. Vérifiez également qu'il n'y a pas de fuites d'eau autour du robinet.
                     </p>
                </div>
              </div>
            </div>
            <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
              <img id="imgser" alt="societe professionel dans le remplacement robinet au maroc"
              src="./admin/pages/remplacement_robinet/imgs/<?php echo $remplacement_robinet["img2"]?>">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
                <h3><strong>Remplacement Robinet au Maroc</strong></h3>
                <p>
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Fermer l'arrivée d'eau : Avant de commencer à démonter le robinet existant, vous devez fermer l'arrivée d'eau. Cela évitera que l'eau ne coule pendant le remplacement.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Vider les tuyaux : Ouvrez le robinet existant pour vider l'eau des tuyaux. Cela permettra d'éviter les éclaboussures d'eau lorsque vous démonterez le robinet.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Retirer le robinet existant : Utilisez une clé à molette pour dévisser les raccords du robinet existant. Si le robinet est fixé à la surface, utilisez un tournevis pour retirer les vis.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Nettoyer la surface : Retirez le vieux mastic et nettoyez la surface où le nouveau robinet sera installé.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Installer le nouveau robinet : Placez le nouveau robinet sur la surface de montage. Vissez les raccords du robinet en utilisant une clé à molette. 
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Raccorder les tuyaux : Utilisez les raccords fournis avec le nouveau robinet pour raccorder les tuyaux. Assurez-vous que les joints d'étanchéité sont bien placés.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Vérifier l'étanchéité : Ouvrez l'arrivée d'eau et vérifiez que le robinet ne fuit pas. Si vous constatez une fuite, serrez les raccords du robinet avec une clé à molette.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Nettoyer : Nettoyez la zone autour du robinet et retirez tout résidu de mastic.
                </p>
              </div>
            </div>
          </div>
