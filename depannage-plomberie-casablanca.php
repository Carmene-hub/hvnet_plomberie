...
$depannage_plomberie= $conn->prepare("SELECT * from depannage_plomberie Limit 1");
$depannage_plomberie->execute();
$depannage_plomberie = $depannage_plomberie->fetch();
...
<head>
  ...
  <title> Societe de depannage plomberie casablanca - HVNET PLOMBERIE</title>
  <meta name="description"
    content="Societe de depannage plomberie societe professionel dans le depannage plomberie au maroc">
    <meta name="keywords" content="Depannage plomberie casablanca , societe depannage plomberie casablanca , Depannage plomberie casablanca , entreprise depannage plomberie casablanca, Depannage plomberie casablanca Maroc , societe depannage plomberie casablanca Maroc , Depannage plomberie casablanca Maroc, Depannage plomberie Maroc, societe depannage plomberie Maroc , Depannage plomberie Maroc">
  ...
  <!-- Link canonique -->
  <link rel="canonical" href="index.php/depannage-plomberie-casablanca.php">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            ...
            <div class="elementor-text-editor elementor-clearfix">
              <h1 id="paragraphe" class="titre-principal" style="text-align: center;"><strong>Depannage Plomberie Casablanca</strong></h1>
             <?php echo $depannage_plomberie["presentation"];?>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <img id="imgser" alt="societe professionel dans le depannage plomberie a casablanca"
              src="admin/pages/depannage_plomberie/imgs/<?php echo $depannage_plomberie["img1"];?>">
          </div>
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
                <h1 id="paragraphe" class="titre-secend"></h1><strong>Rassembler les outils nécessaires</strong></h1>
                <p>Avant de commencer le dépannage de plomberie, assurez-vous d'avoir les outils nécessaires à portée de main. Cela peut inclure une clé à molette, un tournevis, un couteau, une lampe de poche et un ruban de téflon.
                </p>
                <p>Si vous avez une fuite d'eau, la première étape est de fermer l'arrivée d'eau. Ensuite, utilisez un chiffon pour sécher la zone autour de la fuite. Si la fuite est causée par une fissure ou une rupture dans le tuyau, vous devrez remplacer le tuyau endommagé. Si la fuite est causée par un joint usé, vous pouvez le remplacer en utilisant du ruban de téflon pour étanchéifier le joint.</p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
                <h2 id="paragraphe" class="titre-principal" style="text-align: center;"><strong>Depannage Plomberie</strong></h1>
                  <p>Si vous avez une canalisation bouchée, commencez par retirer tout objet visible à l'entrée de la canalisation. Utilisez ensuite une ventouse pour essayer de déboucher la canalisation. Si la ventouse ne fonctionne pas, utilisez un nettoyant pour canalisation pour dissoudre le bouchon. Évitez d'utiliser des produits chimiques agressifs car ils peuvent endommager les canalisations.
                  </p>
                  <p>Si vous avez un problème de robinetterie, commencez par couper l'alimentation en eau. Ensuite, retirez le capuchon du robinet et dévissez le corps du robinet. Si le joint est usé, remplacez-le en utilisant du ruban de téflon pour étanchéifier le joint. Si la cartouche du robinet est endommagée, remplacez-la en utilisant une clé à molette. <br>Il est important de noter que certains problèmes de plomberie peuvent être complexes ou dangereux à réparer soi-même. Si vous ne vous sentez pas à l'aise de le faire vous-même, il est recommandé de faire appel à un plombier professionnel pour vous aider.
                  </p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <div class="elementor-text-editor elementor-clearfix">
                  <h2 id="paragraphe" class="titre-secend"><strong>Vérification de la pression de l'eau et l'etat des tuyaux</strong></h1>
                    <p>Si vous avez une pression d'eau faible, vérifiez le régulateur de pression de votre maison. Le régulateur de pression se trouve généralement près du compteur d'eau. Utilisez une clé à molette pour ajuster le régulateur de pression jusqu'à ce que vous obteniez la pression d'eau souhaitée.
                    </p>
                    <p>Lors de tout dépannage de plomberie, il est important de vérifier l'état des tuyaux pour s'assurer qu'ils sont en bon état et qu'ils ne causeront pas de problèmes à l'avenir. Pour ce faire il faudra inspecter les tuyaux , ensuite tester la pression de l'eau , Verifier les joints puis l'etat des raccord et enfin utiliser une camera d'inspection.</p>
                </div>
              </div>
            </div>
            <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
              <img id="imgser" alt="societe professionel dans le depannage plomberie au maroc"
              src="admin/pages/depannage_plomberie/imgs/<?php echo $depannage_plomberie["img2"];?>">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
                <h3><strong>Depannage Plomberie au Maroc</strong></h3>
                <p>
                   <br> <i class="fa-solid fa-angle-down fa-xs" style="color: #7accff;"></i> Identifier le problème : Tout d'abord, il est important d'identifier le problème de plomberie spécifique que vous rencontrez. Cela peut inclure une fuite d'eau, un tuyau cassé, un problème d'évacuation, une pression d'eau faible, etc.
                   <br> <i class="fa-solid fa-angle-down fa-xs" style="color: #7accff;"></i> Évaluer la situation : Une fois que vous avez identifié le problème, évaluez la situation afin de faire appel à un professionnel.
                   <br> <i class="fa-solid fa-angle-down fa-xs" style="color: #7accff;"></i> Réparer la plomberie : Effectuez la réparation en suivant les instructions du fabricant ou en utilisant les techniques appropriées pour le problème spécifique. 
                   <br> <i class="fa-solid fa-angle-down fa-xs" style="color: #7accff;"></i> Vérifier les réparations : Une fois la réparation terminée, vérifiez que tout fonctionne correctement en ouvrant l'alimentation en eau et en testant le système.
                   <br> <i class="fa-solid fa-angle-down fa-xs" style="color: #7accff;"></i> Nettoyer : Nettoyez toute l'eau ou les débris qui ont été générés pendant la réparation.
                   <br> <i class="fa-solid fa-angle-down fa-xs" style="color: #7accff;"></i> Vérifier pour d'autres problèmes : Vérifiez si d'autres problèmes de plomberie sont présents ou pourraient survenir dans un proche avenir.
