...
<body class="home">
    <div class="wrap"><!-- Header Start -->
        ...
        <img id="imblog" src="img/une-salle-de-bain-ecologique-zoom-sur-le-corian.jpg" alt="salle de bain">

        <div class="row" style="padding: 250px; margin-top: -200px;">
            <p style="text-align: center;">Dès lors qu’il s’agit d’imaginer des idées déco pour une salle de bains, on
                redoute le montant des travaux nécessaires à la modernisation de cette pièce. Vous allez voir qu’en
                misant sur des matériaux appropriés et quelques accessoires stylés, il est possible de métamorphoser cet
                espace pour en faire une salle de bains design, contemporaine ou zen, à moindres frais.</p>

            <h3 style="margin-left: 280px;">Mettez votre salle de bains au goût du jour en quelques coups de pinceau !
            </h3>
            <br>
            <br>
            <p>Toutes les émissions TV spécialisées en parlent, la clé d’une transformation réussie passe souvent par un
                habile coup de pinceau. Que vous optiez pour l’application d’une résine spéciale pour couvrir un
                carrelage démodé ou d’une peinture classique pour revisiter la couleur de vos murs, avec du matériel
                adapté vous parviendrez à changer le look de votre salle de bains pour pas cher. Attention toutefois,
                veillez bien à choisir un produit adapté aux pièces humides, vous éviterez ainsi la prolifération des
                moisissures et vous faciliterez la vie par rapport au nettoyage.
            </p>
            <br>
            <h3 style="margin-left: 440px;">Optez pour des nouveaux miroirs </h3>
            <p>En plus du miroir principal disposé au-dessus du lavabo, peut-être pourriez-vous en placer de nouveaux en
                complément ? Par exemple, si vous accrochez des miroirs de barbier, accessoire très branché
                actuellement, vous démultiplierez l’impression d’espace dans la pièce en la rendant plus lumineuse. À ne
                pas négliger dans votre sélection d’idées déco spéciale petite salle de bains !</p>
            <br>
            <br>
            <h3 style="margin-left: 360px;">Rafraîchir le sol d’une salle de bains à faible coût </h3>
            <p>Nous comprenons que vous n’ayez pas envie de tout casser, c’est anxiogène et générateur de poussière à
                souhait. Alors, pour renouveler votre ancien sol, pourquoi ne pas opter pour un revêtement en PVC ? En
                version adaptée aux pièces humides, ces matériaux n’ont plus rien à voir avec les linoléums anciens des
                grands-mères. On en trouve de toutes sortes, déclinant des effets déco très actuels comme le béton ciré,
                le parquet ou les carreaux de ciment.</p>

            <h3 style="margin-left: 380px;">Les couleurs déco idéales pour la salle de bains </h3>
            <p>Gardez toujours en tête que le vert est une couleur à bannir de la salle de bains sous peine d’effet
                mauvaise mine au réveil. Cependant, les verts doux, très à la mode actuellement, comme les tons sauge,
                lichen, amande ou olive… peuvent apporteront beaucoup de fraîcheur et de luminosité à votre pièce.
                Surtout si vous les combinez avec d’autres éléments déco très clairs ou du blanc, par exemple. Classique
                et chic, le thème bleu et blanc ou « mer » continue d’être présent dans les idées déco des salles de
                bains d’aujourd’hui. Pour leur part, des murs de couleur claire amplifieront l’impression d’espace dans
                la pièce. Les couleurs claires sont également intéressantes dans la salle de bains car elles procurent
                un effet bonne mine immédiat. Pour cela, misez de préférence sur des nuances douces et chaleureuses
                comme le rose saumoné, le corail ou la nuance terracotta, très à la mode. Pour une atmosphère plus
                secrète, vous miserez sur des teintes bleu canard, aubergine ou anthracite… effet déco assuré pour une
                salle de bains unique.</p>
            <p>Ne tremblez plus face au relooking de votre salle de bains, nos idées déco vont vous offrir une
                projection de ce qui pourrait ressembler à votre nouvelle et magnifique pièce d’eau.</p>
        </div>
        ...
        <footer id="footer">
            <!-- Footer Top Start -->
            <div class="footer-top" style="margin-top: -380px;">
