...
$urgence_plombier= $conn->prepare("SELECT * from urgence_plombier Limit 1");
$urgence_plombier->execute();
$urgence_plombier = $urgence_plombier->fetch();
...
<head>
  ...
  <title> Societe urgence plomberie casablanca - HVNET PLOMBERIE</title>
  <meta name="description"
    content="Societe urgence plomberie societe professionel dans urgence plomberie au maroc">
    <meta name="keywords" content="Urgence plombierie casablanca , societe urgence plombierie casablanca , Urgence plombierie casablanca , entreprise urgence plombierie casablanca, Urgence plombierie casablanca Maroc , societe urgence plombier ie casablanca Maroc , Urgence plombierie casablanca Maroc, Urgence plombierie Maroc, societe urgence plombierie Maroc , Urgence plombierie Maroc">
  ...
  <!-- Link canonique -->
  <link rel="canonical" href="index.php/urgence-plombier-casablanca.php">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            ...
            <div class="elementor-text-editor elementor-clearfix">
              <h1 id="paragraphe" class="titre-principal" style="text-align: center;"><strong>Urgence Plombier Casablanca</strong></h1>
             <?php echo $urgence_plombier ["presentation"];?>
        ...
        <div class="row">
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <img id="imgser" alt="societe professionel dans urgence plomberie a casablanca"
              src="admin/pages/urgence_plombier/imgs/<?php echo $urgence_plombier ["img1"];?>">
          </div>
          <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
                <h1 id="paragraphe" class="titre-secend"></h1><strong>Besoin d'une Intervention Rapide en Plomberie ? <br> Nous sommes là pour vous !</strong></h1>
                <p>Quand une situation urgente en plomberie survient, il est essentiel d'agir rapidement pour éviter tout dommage potentiel. Notre service d'urgence en plomberie est spécialement conçu pour répondre à vos besoins pressants, 24 heures sur 24, 7 jours sur 7. </p>
                <p>Que vous soyez aux prises avec une fuite d'eau, une canalisation bouchée ou tout autre problème de plomberie qui requiert une intervention immédiate, notre équipe de professionnels qualifiés est prête à intervenir rapidement.</p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
                <h2 id="paragraphe" class="titre-principal" style="text-align: center;"><strong>Urgence Plombier</strong></h1>
                  <p>Si vous êtes confronté à une situation d'urgence plomberie, ne laissez pas le problème s'aggraver. Contactez notre équipe dès maintenant, et nous viendrons à votre rescousse avec une intervention rapide et des solutions fiables. Votre tranquillité d'esprit est notre priorité, et nous sommes là pour vous aider à surmonter les défis de plomberie, même dans les situations les plus critiques. </p>
                  <p>Lorsque le plombier d'urgence arrive, guidez-le vers le lieu de la fuite ou du problème de plomberie. Donnez-lui autant d'informations que possible sur la situation et toute action que vous avez entreprise pour résoudre le problème. Ensuite, laissez-le faire son travail. Assurez-vous simplement d'être disponible pour répondre à toutes les questions qu'il pourrait avoir.
                  </p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                <div class="elementor-text-editor elementor-clearfix">
                  <h2 id="paragraphe" class="titre-secend"><strong>Notre responsabilite pour vous eviter les urgence en plomberie</strong></h1>
                    <p>
                      <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Entretenez régulièrement vos équipements de plomberie 
                      <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Faites appel à un professionnel pour l'installation de vos équipements 
                      <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Évitez de jeter des déchets solides dans les toilettes et les éviers
                      <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Évitez d'utiliser des produits chimiques pour déboucher les canalisations
                      <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Surveillez votre consommation d'eau
                    </p>
                </div>
              </div>
            </div>
            <div class="col-xl-6  col-lg-6 col-md-12 col-sm-12 col-xs-12 text-center">
              <img id="imgser" alt="societe professionel dans urgence plomberie au maroc"
              src="admin/pages/urgence_plombier/imgs/<?php echo $urgence_plombier ["img2"];?>">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xl-12  col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
              <div class="elementor-text-editor elementor-clearfix">
                <h3><strong>Notre Engagement en Matière d'Urgences Plomberie</strong></h3>
                <p>
                Si une situation d'urgence en plomberie survient , notre équipe se mobilise promptement afin de prévenir toute aggravation des dommages :
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Disponibilité Ininterrompue : Peu importe l'heure du jour ou de la nuit, nos experts en plomberie sont disponibles pour répondre à votre appel d'urgence.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Intervention Rapide : Nous comprenons l'importance de réagir rapidement en cas d'urgence. Dès que nous recevons votre appel, notre équipe se met en route pour résoudre votre problème dans les plus brefs délais.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Équipement Avancé : Notre équipe est équipée d'outils et de technologies de pointe pour diagnostiquer et résoudre efficacement les problèmes de plomberie urgents.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Solutions Durables : Nous ne nous contentons pas de corriger le problème à court terme. Notre objectif est de fournir des solutions durables qui minimisent les risques de récidive.
                  <br> <i class="fa-solid fa-check fa-xs" style="color: #7accff;"></i> Professionnalisme Assuré : Tous nos techniciens sont des professionnels expérimentés et formés pour traiter les urgences plomberie avec efficacité et respect.
