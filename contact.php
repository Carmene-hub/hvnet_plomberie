    ...
    <div class="wrap"><!-- Header Start -->
        ...
        <header id="header">
                                    ...
                                    <form method="POST" action="traitementcontact.php">
                                        <div id="contactFormHolder">
                                            <div class="inputAndLabelCon">
                                                <label for=""> <strong>Nom</strong><span class="necessary">*</span></label><br>
         ...
         height: 40px; " required="">
                                            ...
                                            <div class="inputAndLabelCon">
                                                <label for=""> <strong>Prenom</strong><span class="necessary">*</span></label><br>
                                                <input type="text" name="prenom" placeholder="Prenom" style=" border: 1px solid #5AC8E8 !important; border-radius: 10px;
         font-family: arial;
         font-Weight: bold;
         font-size: 18px;
         color: #6c757d;  width: 100%;
         height: 40px; " required="">
                                            ...
                                            <div class="inputAndLabelCon">
                                                <label for="">   <strong>Telephone</strong><span class="necessary">*</span></label><br>
                                                <input style=" border: 1px solid #5AC8E8 !important; border-radius: 10px;
         font-family: arial;
         font-Weight: bold;
         font-size: 18px;
         color: #6c757d;  width: 100%;
         height: 40px; " type="tel" name="telephone" placeholder="Tél" maxlength="10"
                                                    onkeypress="return onlyNumberKey(event)" required="">
                                            </div>
                                            <div class="inputAndLabelCon">
                                                <label for="">   <strong>Adresse</strong><span class="necessary">*</span></label><br>
                                                <input style=" border: 1px solid #5AC8E8 !important; border-radius: 10px;
         font-family: arial;
         font-Weight: bold;
         font-size: 18px;
         color: #6c757d;  width: 100%;
         height: 40px; " type="tel" name="adresse" placeholder="Adresse" maxlength="10"
                                                    onkeypress="return onlyNumberKey(event)" required="">
                                            </div>
         ...
         height: 40px; " type="text" name="email" placeholder="Email" required="">
                                            ...
                                            <div class="inputAndLabelCon" id="rt">
                                                <label> <strong>Type Local</strong><span class="necessary">*</span></label><br>
                                                <select name="typelocal" id="TypeLocal" style=" border: 1px solid #5AC8E8 !important;
         font-family: arial;
         font-Weight: bold;
         font-size: 18px;
         color: #6c757d;  width: 100%;
         height: 40px; " required="">
                                            ...
                                            <div class="inputAndLabelCon" id="rt">
                                                <label> <strong>Type Service</strong><span class="necessary">*</span></label><br>
                                                <select name="typeservice" id="TypeService" style=" border: 1px solid #5AC8E8 !important;
         font-family: arial;
         font-Weight: bold;
         font-size: 18px;
         color: #6c757d;  width: 100%;
         height: 40px; " required="">
                                            ...
                                            <div class="inputAndLabelCon" id="rt">
                                                ...
                                                <select name="sujet" style=" border: 1px solid #5AC8E8 !important;
         font-family: arial;
         font-Weight: bold;
         font-size: 18px;
         color: #6c757d;  width: 100%;
         ...
         height: 100px; " type="text" name="message" placeholder="Message" required=""></textarea><br><br>
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                ...
                                <div class="content-box-info" style="text-align: left;">
                                    <h4 class="title">Société de Plomberie à casablanca</h4>
